...
export default function ChattingInterFace({ contact_id, modal }) {
    ...
    return (
        <div style={{ height: "100vh", display: "flex", flexDirection: "column", paddingLeft: "0.5px" }} className='chat-interface'>
            ...
            <div style={{ height: `${windowHeight !== undefined || isMobileWidth ? windowHeight - 160 + "px" : "100%"}`, padding: "", scrollBehavior: "smooth" }} className='px-lg-4 px-md-2 px-sm-1 px-xs-1 text-white overflow-scroll'>
